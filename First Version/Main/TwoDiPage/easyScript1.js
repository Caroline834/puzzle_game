...
/*Random*/
squirandomImgOrder = squi_e_imgOrder.sort(() => 0.5 - Math.random());
chickenrandomImgOrder = chicken_e_imgOrder.sort(() => 0.5 - Math.random());
fishrandomImgOrder = fish_e_imgOrder.sort(() => 0.5 - Math.random());
puppyrandomImgOrder = puppy_e_imgOrder.sort(() => 0.5 - Math.random());
...
function dragEnd1(){
    ...
    let squi_r1 = parseInt(currCoords1[0]);
    let squi_c1 = parseInt(currCoords1[1]);

    otherCoords1 = otherTile1.id.split("-");
    let squi_r2 = parseInt(otherCoords1[0]);
    let squi_c2 = parseInt(otherCoords1[1]);
    ...
    if(isAdjacent1){
        let squi_currImg = curTile1.src;
        let squi_otherImg = otherTile1.src;
...
let win1 = true;
    ...
    if (win1) {
        ...
        swal("You Win!", "Congratulation!", "success");
